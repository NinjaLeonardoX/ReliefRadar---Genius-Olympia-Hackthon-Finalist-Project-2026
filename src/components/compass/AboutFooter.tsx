...
export function AboutFooter() {
  return (
    <footer className="rounded-2xl border border-border bg-surface p-5 text-sm text-foreground/75">
      <p>
        Disaster Compass complements official alerts and emergency services; it does not replace
        911. Actions and routes are rules-based and explainable. AI only phrases guidance. In a real
